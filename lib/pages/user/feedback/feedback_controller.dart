...
extension FeedbackStore on FeedbackController {
  ...
  static Future<bool> shouldFeedback() async {
    ...
    final last = DateTime.fromMicrosecondsSinceEpoch(int.parse(lastString) * 1000);
...
class FeedbackController extends GetxController with NetMixin {
  ...
  void choseImage() async {
    final config = AssetPickerConfig(selectedAssets: images, maxAssets: assetLimit, requestType: RequestType.image);
